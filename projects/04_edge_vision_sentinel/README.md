...
2026-09-03 已在树莓派 5 验证代码 `303781c`：USB 摄像头到 HOG 推理链路处理
10 帧成功，未保存或上传画面；本次检测数为 0，**尚未验证有人的正样本检出效果或准确率**。
完整回归 312 项通过，具体环境和限制见[实机记录](../../docs/real-device-validation.md)。
