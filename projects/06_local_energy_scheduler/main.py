...
def demo() -> None:
    windows = [
        EnergyWindow("中午光伏", 0.55, solar_surplus_kw=2.0, capacity_kw=3.0),
        EnergyWindow("晚间高峰", 1.20, solar_surplus_kw=0.0, capacity_kw=2.0),
        EnergyWindow("夜间低谷", 0.35, solar_surplus_kw=0.0, capacity_kw=3.0),
    ]
    loads = [
